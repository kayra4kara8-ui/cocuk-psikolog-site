...
export default function RootLayout({ children }) {
  return (
    <html lang="tr">
      ...
      <body className="bg-warm-50 text-stone-800 antialiased">
        {children}
        {/* Yüzen WhatsApp Butonu */}
        <a
          href="https://wa.me/905386819654?text=Merhaba%2C%20randevu%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
